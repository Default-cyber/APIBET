...
class SportingbetScraper(BaseBookmaker):
    def __init__(self):
    ...
    async def get_matches(self, sport: str = "soccer") -> List[Match]:
        ...
        try:
            async with async_playwright() as p:
                ...
                await page.goto("https://sports.sportingbet.com/pt-br/sports", timeout=20000)
